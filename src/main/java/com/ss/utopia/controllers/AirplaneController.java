...
public class AirplaneController {
  ...
  public ResponseEntity<Object> findBySearchAndFilter(
    ...
    List<Airplane> airplanesList = airplaneService.findBySearchAndFilter(
      filterMap
    );
    return !airplanesList.isEmpty()
      ? new ResponseEntity<>(airplanesList, HttpStatus.OK)
  ...
  public ResponseEntity<Object> insert(
    @RequestBody Map<String, String> airplaneMap
  )
    throws AirplaneTypeNotFoundException {
    LOGGER.info(airplaneMap.toString());
    Integer airplaneTypeId = Integer.parseInt(
      airplaneMap.get("airplaneTypeId")
    );
